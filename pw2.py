...
from utils_PW2_complete import DnCNN, CustomDataset, make_learning_set, generate_logdir, Logger, ensemble_inference
...
model = DnCNN(channels=n_channels, num_of_layers=20)
...
#
#             # Compute loss
#             val_mse_sum += mse_loss(val_denoised_batch, val_target_batch)
#
#         val_mse = val_mse_sum.item() / len(val_generator)
...
with torch.no_grad():
    ...
    # Load model
    saved_model_path = '/home/flemarch/Documents/Florian/THESE/ENSEIGNEMENT/2020-2021/formation_supelec/TP/formation_eavesdropping_denoising/logs/20_10_2020_11_19_47/best_model.pth'
    checkpoint = torch.load(saved_model_path)
    model.load_state_dict(checkpoint)
    # print(path.split(saved_model_path)[0])
    ...
    avg_test_mse = test_mse_sum.item() / len(test_generator)
